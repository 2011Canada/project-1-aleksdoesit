...
public class AdminApproveReimbursementController extends HttpServlet {
	...
	protected void directControlRouter(HttpServletRequest req, HttpServletResponse res)
		...
		case "/adminApprove": {
			...
			case "GET": {
				...
				userController.requestEmployeeHistory(req, res);
				break;
			...
			case "POST": {
				...
				userController.approveReimbursement(req, res);
				break;
