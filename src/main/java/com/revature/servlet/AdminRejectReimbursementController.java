...
public class AdminRejectReimbursementController extends HttpServlet {
	...
	protected void directControlRouter(HttpServletRequest req, HttpServletResponse res)
		...
		case "/adminReject": {
			...
			case "GET": {
				...
				userController.findAllReimbursements(req, res);
				break;
			...
			case "POST": {
				...
				userController.rejectReimbursement(req, res);
				break;
